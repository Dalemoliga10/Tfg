    ...
    <main style="margin-top: 20px;">
        <div class="container d-flex flex-column align-items-center" style="width: 75%;">
            ...
            <ul class="fs-6" style="margin-top: 10px;">
                ...
                <li>Tendrás acceso directo a los enlaces de compra o descarga de todos los juegos disponibles</li>
                <li>Guardar y gestionar juegos en tu lista personal de juegos favoritos</li>
            </ul>
        </div>
